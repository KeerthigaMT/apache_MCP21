...
func Patch_roleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/roles/%s%s", cfg.BaseURL, queryString)
...
func CreatePatch_roleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_roles_role_name",
		mcp.WithDescription("Update a role"),
